...
export default function ProjectsGrid({ filters }: { filters: string[] }) {
  const projects = [
...

    {
      ...
      icon: "👻",
      desc: "Helped in engineering and designing an immersive 3D horror game utilizing the Godot Engine. Scripted core gameplay loops, player movement, and dynamic enemy AI with GDScript, while optimizing real-time lighting and spatial audio to create a tense, high-performance user experience.",
